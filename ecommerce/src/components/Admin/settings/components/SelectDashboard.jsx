...
const SelectDashboard = () => {
  ...
  const handleDashboard = () => setDashboard((prevState) => !prevState);

  return (
    <div className="border  rounded-md mx-2 my-2 py-4 px-4">
      <p className="cursor-pointer bg-sky-100 w-56 h-10 px-2 py-1 rounded-lg text-sm xl:text-base lg:text-base text-teal-800 font-lora font-medium">
        Select all of Dashboard
      </p>
      <div className="w-full flex items-center justify-between flex-wrap xl:justify-start ">
        <div className="flex items-center justify-between w-56 my-2 rounded-md py-1 px-2 bg-neutral-100">
